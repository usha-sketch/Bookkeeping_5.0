...
Feature: Bank tab BK
  ...
  #Scenario: navigate to bank and verify BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #
 #Scenario: verify added bank BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #And add bank BK
 #And verify added bank BK
 #
 #Scenario: verify the edited bank
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #And edit the bank BK
 #And verify the edited bank
 #
 #Scenario: verify enable options in edit bank page BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #And verify enable options in edit bank page BK
 #
 #Scenario: Click on plus symbol in edit bank page BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #Then Click on plus symbol in bank main menu BK
 #
 #Scenario: Verify search icon and cross mark in edit bank page BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #Then Verify search icon and cross mark in edit bank page BK
 #
 #Scenario: Click on double arrows in edit bank page and verify the detail boxes are opening or closing BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #Then Click on double arrows in edit bank page and verify the detail boxes are opening or closing BK
 #
 #Scenario: verify search bar in main grid BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 ...
 #
 #
 #Scenario: verify the imported transactions BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #And import the transactions BK
 #
 #
 #Scenario: export the transaction BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 ...
 #
 #Scenario: verify cash coded transaction BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 #And do cashcoding BK
 #And Verify the cash coding BK
 #
 #Scenario: verify bank reconcilation BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 ...
 #
 #Scenario: verify the type dropdown BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 ...
 #
 #Scenario: verify export options under cash in hand BK
 #Given navigate to inside the client and verify BK
 #Then navigate to bank and verify BK
 ...
 Scenario: verify the receipt details through receipt id in particular bank BK
 Given navigate to inside the client and verify BK
 Then navigate to bank and verify BK
 And verify the receipt details through receipt id in particular bank BK
 
 Scenario: verify the customer details through customer id in particular bank BK
 Given navigate to inside the client and verify BK
 Then navigate to bank and verify BK
