...
public class BK_journal_locators {
	...
	@FindBy(xpath = "(//mat-icon[@role='img'][normalize-space()='add_circle_outline'])[13]")
	@CacheLookup
	public WebElement plusinjournalmainmenu;
	...
	@FindBy(xpath = "//u[text()='choose a file']")
	@CacheLookup
	public WebElement chooseafileone;
	
	@FindBy(xpath = "//mat-icon[text()='attachment']")
	@CacheLookup
	public WebElement attachmenticon;
	
	@FindBy(xpath = "(//a[text()=' JNL - 2 '])[1]")
	@CacheLookup
	public WebElement journalid;
	
	@FindBy(xpath = "//b[text()='Journal']")
	@CacheLookup
	public WebElement journalele;
	...
	@FindBy(xpath = "//span[text()=' Edit Journal ']")
	@CacheLookup
	public WebElement editjournalele;
	...
	@FindBy(xpath = "//textarea[@formcontrolname='reference']")
	@CacheLookup
	public WebElement referenceTF;
	
	@FindBy(xpath = "(//mat-icon[text()='more_vert '])[1]")
	@CacheLookup
	public WebElement kebabinrow;
	
	@FindBy(xpath = "//span[text()='Copy ']")
	@CacheLookup
	public WebElement copyinkebab;
