...
public class BK_CIS_threehundrud_locators {
	...
	@FindBy(xpath = "(//mat-icon[@role='img'][normalize-space()='add_circle_outline'])[29]")
	@CacheLookup
	public WebElement plusincisthreehundrudmainmenu;
	...
	@FindBy(xpath = "//span[text()='Add CIS300']")
	@CacheLookup
	public WebElement addcis300;
	
	@FindBy(xpath = "//span[normalize-space()='Save & Next']")
	@CacheLookup
	public WebElement saveandexitcis300;
	
	@FindBy(xpath = "//span[text()=' Submit To Capium ']")
	@CacheLookup
	public WebElement submittocapium;
	
	@FindBy(xpath = "//a[text()=' January - 2025 ']")
	@CacheLookup
	public WebElement periodinperiodcolum;
	
	@FindBy(xpath = "//h2[text()='View CIS Monthly Return']")
	@CacheLookup
	public WebElement periodeleinpopup;
}
